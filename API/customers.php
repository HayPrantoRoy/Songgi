...
switch ($method) {
    ...
    case 'POST':
        ...
        $sql = "INSERT INTO customers (name, mobile_no, address, is_active, user_id, create_date, update_date) 
    ...
    case 'PUT':
        ...
        $sql = "UPDATE customers SET name='$name', mobile_no='$mobile_no', address='$address', 
